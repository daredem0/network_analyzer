...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/network-analyzer: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/network-analyzer ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/src/Data.o: src/Data.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Data.o src/Data.cpp
...
${OBJECTDIR}/src/IPRange.o: src/IPRange.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/IPRange.o src/IPRange.cpp
...
${OBJECTDIR}/src/Ping.o: src/Ping.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Ping.o src/Ping.cpp
